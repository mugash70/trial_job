  ...
  const carouselStyle = {
    ...
    export const CustomCarousel = () => {
      ...
      const cardData = [
        ...
        ],sname:'AI',name: 'Artificial Intelligence',
         content: "Unleash the power of personalized AI solutions tailored to your business needs. Our intelligent models automate tasks, predict customer behavior, optimize operations, and perform semantic analysis and demand prediction precisely for your business with unparalleled precision.", icon: <RobotOutlined style={{ fontSize: '40px', color: 'blue', marginRight: '10px' }} /> },
        {content_list: [
